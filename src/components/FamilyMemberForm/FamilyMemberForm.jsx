    ...
    switch (code) {
      ...
      case FAMILY_MEMBER_METADATA_CUSTOMUPDATE.HHM_2_NCDMODULE_INDIVIDUAL:
        ...
        case FAMILY_MEMBER_METADATA_CUSTOMUPDATE.HHM_2_CHOLESTEROL_MEASURED_BY_DOCTOR:
          if(value == "false") {
            metadata[MEMBER_FORM_VALIDATIONS_SECTION.HISTORY_OF_CHOLESTEROL].fileds[FAMILY_MEMBER_METADATA_CUSTOMUPDATE.HHM_2_RAISED_CHOLESTEROL_WARNING].hidden = true;
            metadata[MEMBER_FORM_VALIDATIONS_SECTION.HISTORY_OF_CHOLESTEROL].fileds[FAMILY_MEMBER_METADATA_CUSTOMUPDATE.HHM_2_RAISED_CHOLESTEROL_WARNING_LAST_YEAR].hidden = true;
            metadata[MEMBER_FORM_VALIDATIONS_SECTION.HISTORY_OF_CHOLESTEROL].fileds[FAMILY_MEMBER_METADATA_CUSTOMUPDATE.HHM_2_CHOLESTEROL_MEDICATION_BY_DOCTOR].hidden = true;
            metadata[MEMBER_FORM_VALIDATIONS_SECTION.HISTORY_OF_CHOLESTEROL].fileds[FAMILY_MEMBER_METADATA_CUSTOMUPDATE.HHM_2_LOCAL_HEALER_CONSULTED_FOR_CHOLESTEROL].hidden = true;
            metadata[MEMBER_FORM_VALIDATIONS_SECTION.HISTORY_OF_CHOLESTEROL].fileds[FAMILY_MEMBER_METADATA_CUSTOMUPDATE.HHM_2_CHOLESTEROL_LOCAL_TREATMENT].hidden = true;
          } else {
            metadata[MEMBER_FORM_VALIDATIONS_SECTION.HISTORY_OF_CHOLESTEROL].fileds[FAMILY_MEMBER_METADATA_CUSTOMUPDATE.HHM_2_RAISED_CHOLESTEROL_WARNING].hidden = false;
            metadata[MEMBER_FORM_VALIDATIONS_SECTION.HISTORY_OF_CHOLESTEROL].fileds[FAMILY_MEMBER_METADATA_CUSTOMUPDATE.HHM_2_RAISED_CHOLESTEROL_WARNING_LAST_YEAR].hidden = false;
            metadata[MEMBER_FORM_VALIDATIONS_SECTION.HISTORY_OF_CHOLESTEROL].fileds[FAMILY_MEMBER_METADATA_CUSTOMUPDATE.HHM_2_CHOLESTEROL_MEDICATION_BY_DOCTOR].hidden = false;
            metadata[MEMBER_FORM_VALIDATIONS_SECTION.HISTORY_OF_CHOLESTEROL].fileds[FAMILY_MEMBER_METADATA_CUSTOMUPDATE.HHM_2_LOCAL_HEALER_CONSULTED_FOR_CHOLESTEROL].hidden = false;
            metadata[MEMBER_FORM_VALIDATIONS_SECTION.HISTORY_OF_CHOLESTEROL].fileds[FAMILY_MEMBER_METADATA_CUSTOMUPDATE.HHM_2_CHOLESTEROL_LOCAL_TREATMENT].hidden = false;
          }
        break
